...
import {APanelHeader, APanelTitle, APanelBody, APanelFooter} from "../APanel";
import {AContainer, ARow, ACol} from "../ALayout";
import ASelect from "../ASelect";

<Meta title="Components/Popovers" component={APopover} />
...
```
import APopover from "@cisco-ats/atomic-react/APopover";
// or if you're able to treekshake node_modules
import {APopover} from "@cisco-ats/atomic-react";
```
            ...
            <ARow>
              <ACol className="text-center">
                ...
                <p className="onclose-1__instruction">
                  Clicking outside of the anchor or popover will close the
                  popover in this example.
                </p>
                <APopover
                  anchorRef={buttonRef}
                  open={open}
