...
<Preview>
  <Story name="usage-1">
    ...
    {() => {
      ...
      const [color, setColor] = useState("cisco-blue");
      return (
        <div>
          <h3>Example</h3>
          <ACheckbox checked={checked} color={color} disabled={disabled} indeterminate={indeterminate} wrap={wrap}>
            {LoremIpsum}
          </ACheckbox>
          <ADivider />
          <h3>Options</h3>
          <div className="d-flex mt-4 flex-column">
            ...
            <ASelect label="Color" items={["cisco-blue", "grape", "magenta--burnt-1", "fern--wash-1", "rgba(238, 85, 65, 0.8)"]} onSelected={value => setColor(value)} />
          </div>
        </div>
      );
    }}
