...
```
import {AStepper, AStep, AStepTitle, AStepDescription} from "@cisco-sbg-ui/atomic-react";
```
...
<AFooter>
  <AFooterLegal>*className prop is available on all components.</AFooterLegal>
</AFooter>
