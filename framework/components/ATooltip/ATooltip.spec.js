context("AMenuBase", () => {
  ...
  it("supports themes", () => {
    ...
    cy.get("#story--components-tooltips--position-1 .a-button")
      ...
      .click();
    cy.get("#story--components-tooltips--position-1 .a-button").eq(1).click();
    cy.get("#story--components-tooltips--position-1 .a-button").eq(2).click();
    cy.get("#story--components-tooltips--position-1 .a-button").eq(3).click();
    cy.get("#story--components-tooltips--position-1 .a-button").eq(4).click();
    cy.get("#story--components-tooltips--position-1 .a-button").eq(5).click();
    cy.get("#story--components-tooltips--position-1 .a-button").eq(6).click();
    cy.get("#story--components-tooltips--position-1 .a-button").eq(7).click();
    cy.get("#story--components-tooltips--position-1 .a-button").eq(8).click();
    cy.get("#story--components-tooltips--position-1 .a-button").eq(9).click();
    cy.get("#story--components-tooltips--position-1 .a-button").eq(10).click();
    cy.get("#story--components-tooltips--position-1 .a-button").eq(11).click();
