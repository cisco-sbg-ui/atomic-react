    ...
    <ATheme>
      <YourComponent>
        {() => {
          ...
          return (
            <div style={{padding:20, backgroundColor: currentTheme === "default" ? '#fff' : '#000'}}>
              <AButtonGroup selectedValues={[currentTheme]} onChange={(_, selectedValues) => setCurrentTheme(selectedValues[0])}>
