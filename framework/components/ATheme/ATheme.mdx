...
```
import {useAAutoTheme} from "@cisco-sbg-ui/atomic-react";
```
...
render(
  <ATheme>
    <AAutoTheme defaultEnabled={true}>
      <ThemeSwitcher />
    </AAutoTheme>
  </ATheme>
);
...
<ASimpleTable className="mb-8">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <p className='mt-0'>
          Enables automatic theming within an atomic-react application.
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <p className='mt-0'>
          Disables automatic theming within an atomic-react application.
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <p className='mt-0'>
          Toggles automatic theming functionality within an atomic-react application. Useful in the case of enabling/disabling automatic theming with an `ACheckbox` or `ASwitch`.
        </p>
      </td>
    </tr>
  </tbody>
