...
<Preview>
  ...
  <AApp style={{minHeight: 120}}>
    ...
    <ATag className="cisco-blue white--text ma-1">
      <AIcon left>user</AIcon>User Tag<AIcon right className="cursor-pointer" onClick={() => alert('Close icon clicked!')}>close</AIcon>
    </ATag>
      <YourComponent>
      {() => {
        ...
        return (
          ...
          <ATag className="ma-1 grape white--text" onClick={() => setActive(!active)}>
            {selectedOption} Tag<AIcon right className="cursor-pointer">chevron-down</AIcon>
          </ATag>
          <ADropdown>
            <ADropdownMenu open={active} onClose={() => setActive(false)} style={{right:5}}>
